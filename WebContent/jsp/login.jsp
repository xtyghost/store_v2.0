...
var name="${cookie.remenbername.value}";
$(function(){
   var username=decodeURI(name);
		...
		<div class="row">
			...
			<div class="col-md-5">
				<div
					...
					<font>会员登录</font>USER LOGIN <span id="sigan">${msg}</span>
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/UserServlet" method="post">
						...
						<input type="hidden" name="method" value="Login">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username"
									placeholder="请输入用户名" name="username" value="">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="请输入验证码" name="testcode">
							</div>
							<div class="col-sm-3">
								<img src="${pageContext.request.contextPath}/UserServlet?method=testcode&timer="new Date().getTime()" id="checkcode"/>
									<span>${testmsg}</span>
							</div>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label> <input type="checkbox" name="autoLogin" value="yes"> 自动登录
									</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label> <input
										type="checkbox" name="remenbername" value="yes"> 记住用户名
									</label>
								</div>
							</div>
						</div>
