		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					...
					<a href="${pageContext.request.contextPath}/./蔬菜分类.htm">手机数码&nbsp;&nbsp;&gt;</a>
					
					</c:if>
					<c:if test="${product.cid==0 }">
					<a href="${pageContext.request.contextPath}/./蔬菜分类.htm">电脑办公&nbsp;&nbsp;&gt;</a>
					</c:if>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<!--用于订单的表单  -->
                            <form action="${pageContext.request.contextPath}/CartServlet" method="post" id="cartsub">
                            <div>
							...
							<div style="margin:20px 0 10px 0;;text-align: center;">
									<input style="background: url('./images/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button" id="subm">
								 &nbsp;收藏商品</div>
								</form>
						</div>
					</div>
