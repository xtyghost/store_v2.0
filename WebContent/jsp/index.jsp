		...
		<div class="container-fluid">
			<div id="carousel-example-generic" class="carousel slide"
				...
				<a class="left carousel-control"
					href="${pageContext.request.contextPath}/#carousel-example-generic"
			...
			<div class="col-md-10">
				<div class="col-md-6"
					...
					<a href="${pageContext.request.contextPath}/product_info.htm">
						...
						width="400px" height="200px" style="display: inline-block;">
					</a>
				</div>
				<c:forEach var="i" items="${ requestScope.hlist }" > 
					<div class="col-md-2"
						...
						<p>
							<a href="${pageContext.request.contextPath}/ProductServlet?method=findbypid&pid=${i.pid}"
								style='color: #666'>${i.pname}</a>
						</p>
						<p>
							<font color="#E4393C" style="font-size: 16px">&yen;${i.shop_price}</font>
						</p>
					</div>
				</c:forEach>
		...
		<div class="container-fluid">
			...
			<div class="col-md-10">
				<div class="col-md-6"
					...
					<c:forEach var="i" items="${requestScope.nlist}"> 
					<div class="col-md-2"
						style="text-align: center; height: 200px; padding: 10px 0px;">
						<a href="${pageContext.request.contextPath}/ProductServlet?method=findbypid&pid=${i.pid}">
							<img
